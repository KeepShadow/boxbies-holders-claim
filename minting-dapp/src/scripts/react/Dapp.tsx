...
const defaultState: State = {
  ...
  network: null,
  networkConfig: CollectionConfig.testnet, //mainnet
  isPaused: true,
  loading: false,
...
/*   async mintTokens(amount: number): Promise<void>
  ...
  async whitelistMintTokens(): Promise<void>
  {
    try {
      this.setState({loading: true});
            ...
            {this.isContractReady() ?
              <>
                <CollectionStatus
                  ...
                  userClaimAmount={this.state.userClaimAmount}
              ...
              {/*   {!this.isSoldOut() ? */}
                  <MintWidget
                    ...
                    isPaused={this.state.isPaused}
                    isUserInWhitelist={this.state.isUserInWhitelist}
                    claim={() => this.whitelistMintTokens()}
